...
class UserInterface:
    def __init__(self,controller:Controller):
        ...
        true_image = PhotoImage(file="D:\Python Studies\Intermediate Python\Tkinter_Python\ASSIGNMENT\Proj5_QuizApp_Solution\images\check.png")
        self.true_button=Button(image=true_image,command=self.true_pressed)
        self.true_button.grid(row=2,column=1)

        false_image = PhotoImage(file="ASSIGNMENT\Proj5_QuizApp_Solution\images/remove.png")
